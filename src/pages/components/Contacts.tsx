    ...
    <>
      <ContactWrapper>
        <RowWrap>
          ...
          <a target="_blank" href="https://github.com/Accia97">
            <Icon src={githubIcon.src} />
          </a>
          <a
            target="_blank"
            href="https://www.linkedin.com/in/stefano-cammarata-b4a147218/"
          >
        ...
        <RowWrap>
          ...
          <p>Chiara Ferrara</p>
          <a target="_blank" href="https://gist.github.com/chiaraferrara">
            <Icon src={githubIcon.src} />
          </a>
          <a
            target="_blank"
        ...
        <RowWrap>
          ...
          <p>Erika Ciminelli</p>
          <a target="_blank" href="https://github.com/erikacimi">
            <Icon src={githubIcon.src} />
          </a>
          <a
            target="_blank"
            href="https://www.linkedin.com/in/erika-ciminelli-48704019b/"
          >
            <Icon src={linkedinIcon.src} />
          </a>
        </RowWrap>
