...
export default async function handler(req: any, res: any) {
  ...
  if (req.method == "PATCH") { 
    const { name, logo, coach, points_scored, points_given, total_points, played_games } =
      req.body;
//devo gestire due patch diverse, quindi devo fare un controllo su quali parametri mi arrivano
      if (points_scored !== undefined && points_given !== undefined && total_points !== undefined && played_games !== undefined) {
